      ...
      <div className="mx-auto max-w-[1400px] px-6 py-16 md:px-8">
        <div className="grid gap-10 md:grid-cols-[1.5fr_1fr_1fr]">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3 text-[16px] text-on-dark/80">
              <li><a href="#sobre" className="hover:text-on-dark">Sobre</a></li>
              <li><a href="#status" className="hover:text-on-dark">Status</a></li>
              <li><a href="#vantagens" className="hover:text-on-dark">Vantagens</a></li>
              <li><a href="#cadastro" className="hover:text-on-dark">Cadastro</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3 text-[16px] text-on-dark/80">
              <li><a href="mailto:contato@hellcore.club" className="hover:text-on-dark">contato@hellcore.club</a></li>
              <li><a href="#cadastro" className="hover:text-on-dark">Entrar na lista</a></li>
            </ul>
          </div>
        </div>
