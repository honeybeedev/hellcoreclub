    ...
    <section id="cadastro" className="bg-ink text-on-dark">
      <div className="mx-auto grid max-w-[1400px] gap-12 px-6 py-20 md:grid-cols-2 md:gap-16 md:px-8 md:py-28">
        <div className="flex flex-col justify-center">
          ...
          <h2 className="display-hero text-[clamp(2.25rem,7vw,6rem)]">
            Garanta
            <br />
            seu lugar
          </h2>
          <p className="display-300 mt-6 max-w-md text-[clamp(1.125rem,2.2vw,1.5rem)] leading-snug text-on-dark/90">
